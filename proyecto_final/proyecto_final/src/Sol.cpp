...
Sol::Sol(string file, float r, float g, float b, float ka, float kd) : Object(file)
{
...
void Sol::set_transf(arma::Mat<double> transf)
{
    this->matrix = transf;
}


void Sol::dibuja(float Ia, float Ip, arma::frowvec3 F)
{
